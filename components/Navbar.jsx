...
import { showToast } from "@/lib/sweetToast";
...
export default function Navbar() {
  ...
  // ✅ auto detect login/logout without refresh
  useEffect(() => {
          ...
          {!isLoggedIn ? (
            ...
            <>
              ...
              <button
                ...
                className="px-4 py-1.5 rounded-lg text-white bg-red-500 hover:bg-red-700 transition hover:scale-105 font-semibold"
              >
                Logout
              </button>
            </>
